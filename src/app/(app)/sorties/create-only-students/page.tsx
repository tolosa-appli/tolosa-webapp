...
export default function CreateOnlyStudentsOutingPage() {
    ...
    const onSubmit = (data: CreateOutingFormData) => {
        console.log("New student outing created:", data);
        toast({
            title: "òsca !",
            description: "La sortie étudiante a bien été créée !",
        });
        ...
        <div className="container mx-auto p-4 md:p-8">
            <div className="mb-6">
                 <Button asChild variant="ghost" className="mb-4 -ml-4">
                    <Link href="/students">
                        ...
                        Retour aux sorties étudiantes
                    </Link>
                </Button>
                <h1 className="text-3xl font-bold font-headline">Créer une sortie étudiante</h1>
                <p className="text-muted-foreground">Proposez une sortie exclusivement pour la communauté étudiante.</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="flex justify-end">
                    <Button type="submit" size="lg">Créer la sortie étudiante</Button>
                </div>
            </form>
        </div>
    );
